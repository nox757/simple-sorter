...
public class BaseSorterTest {
    ...
    @Test
    public void mutableSorter() {
        BaseSorter<String> target = new BaseSorter<>(sortStrategy, comparator);
    ...
    public void sortArray() {
        ...
        BaseSorter<String> sorter = new BaseSorter<>(sortStrategy, comparator);
